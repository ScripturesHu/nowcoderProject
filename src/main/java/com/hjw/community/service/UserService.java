...
import com.hjw.community.entity.LoginTicket;
import com.hjw.community.entity.User;
import com.hjw.community.mapper.LoginTicketMapper;
...
public class UserService implements CommunityConstant {
    ...
    public Map<String, Object> register(User user){
        ...
        // 注册用户
        user.setSalt(CommunityUtil.generateUUID().substring(0, 5));//生成一段五位数的随机字符码
